...
To better understand how the frequency mixing works, I created a simulation model of the circuit with *[LTSpice](https://www.analog.com/en/design-center/design-tools-and-calculators/ltspice-simulator.html#)*. You can grab the simulation files [here](https://github.com/MarcelMG/Heterodyne_Bat_Detector/tree/master/simulation) and play around with it.
